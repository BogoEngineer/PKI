...
class FoodItemViewModel : ViewModel(){
    ...
    private val foodItemsAllowed : MutableLiveData<List<FoodItem>> = MutableLiveData()

    private val foodItemsNotAllowed : MutableLiveData<List<FoodItem>> = MutableLiveData()
