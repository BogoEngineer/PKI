...
import com.veskekatke.healthformula.BuildConfig
...
val coreModule = module {
    ...
    single { Room.databaseBuilder(androidContext(), PostDatabase::class.java, "PostDb")
        .fallbackToDestructiveMigration()
        .build() }

    single { Room.databaseBuilder(androidContext(), SupplementDatabase::class.java, "SupplementDb")
        .fallbackToDestructiveMigration()
        .build() }
